...
function refresh(seed) {
  ...
  userWishLists['undefined'] = [0,1,2,49,50].map(count => makeWishlist(rnd, count)),
  userWishLists['950a78eb1a4c498e8336fa4456de9c28'] = [50,49,2,1,0].map(count => makeWishlist(rnd, count)),
  userWishLists['bill'] = []
}
